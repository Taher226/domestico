    ...
    Container(
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          Padding(
            padding: const EdgeInsets.only(right: 230.0),
            child: Text('Latest Requests',style: MyTheme.lightTheme.textTheme.titleMedium,),
          ),
          SizedBox(height: 20.0,),
          Expanded(
              child:
...
//WalkerProfileScreen(),
  ...
  List<String> appBarTitle = ["Home","Shop","Booking","Favourite","Profile"];
    ...
    return Scaffold(
      ...
      appBar: PreferredSize(
        ...
        child: AppBar(
          ...
          title: Padding(
            padding: const EdgeInsets.only(top:30.0),
            child: Text('${title}',style: MyTheme.lightTheme.textTheme.titleLarge,),
          ),
          centerTitle: true,
        ),
      ),
            ...
            InkWell(
              ...
              child: Row(
                  children:[
                    ...
                    SizedBox(width: 20,),
                    Text('Cart',style: MyTheme.lightTheme.textTheme.titleSmall,),
                  ]
              ),
            ),
            SizedBox(height: 50,),
