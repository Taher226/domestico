      ...
      appBar: PreferredSize(
        ...
        child: AppBar(
          ...
          title: Padding(
            ...
            child: Text('Reviews & Ratings',style: MyTheme.lightTheme.textTheme.titleLarge,),
          ),
          centerTitle: true,
        ),
      ),
      ...
      children: [
        Row(
          children: [
            Expanded(
              flex: 3,
              child: Text('4.5',style: TextStyle(fontSize: 50,
            ...
            child: Column(
              children: [
                  ...
                  children: [
                    ...
                    Column(
                      children: [
                        ...
                        Text('Just now',style: TextStyle(color: Colors.grey,fontWeight: FontWeight.bold),)
                      ],
                    ),
                  ],
                ),
                ...
                Padding(
                  ...
                  child: Text('fhgajgfadshfgdhgsdhfgshdfgshgfhsdgfhsdgfhsdgfhsdgfhsgdfhsg'),
                ),
...
final double value;
  ...
  Widget build(BuildContext context) {
    return Row(
                     children: [
     Expanded(flex: 1,child: Text(text,style: MyTheme.lightTheme.textTheme.titleSmall,)),
     Expanded(
       flex: 11,
      child: SizedBox(
